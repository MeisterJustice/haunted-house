...
const door = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    transparent: true,
    alphaMap: doorAlphaTexture, // remove unneccesary width
    aoMap: doorAmbientOcclusionTexture,
    displacementMap: doorHeightTexture, // make it not flat
    displacementScale: 0.1, // reduce displacement
    normalMap: doorNormalTexture, // adds details
    metalnessMap: doorMetalnessTexture,
    roughnessMap: doorRoughnessTexture,
  })
);
// for the doorAmbientOcclusionTexture to work
